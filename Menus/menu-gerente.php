...
<table width="777" height="298" border="0" align="center" cellspacing="0">
  <tr>
    <td colspan="7" bgcolor="#009966"><p>Bienvenido: <strong><?php echo $_SESSION['Nick']?></p>
      <p><a href="../Login/desconectar.php">Salir</a></p></td>
  </tr>
  <tr>
    <td colspan="7" bgcolor="#0066FF"><div align="center" class="Estilo1">MENU</div></td>
  </tr>
  <tr>
    <td width="36" bgcolor="#0066FF">&nbsp;</td>
    <td width="129" bgcolor="#0066FF"><label>
      <input type="submit" name="Submit" value="Generar Ventas de Asesores" />
    </label></td>
    <td width="17" bgcolor="#0066FF">&nbsp;</td>
    <td width="115" bgcolor="#0066FF"><label>
      <input type="submit" name="Submit2" value="Generar Ventas de Supervisores" />
    </label></td>
    <td width="20" bgcolor="#0066FF"><label></label></td>
    <td width="106" bgcolor="#0066FF"><label>
      <input type="submit" name="Submit3" value="Generar Ventas Totales" />
    </label></td>
  ...
  <tr>
    <td colspan="7" bgcolor="#009966"><label></label></td>
  </tr>
</table>
</form>
